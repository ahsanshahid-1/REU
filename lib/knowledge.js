...
const BASE_CHUNKS = [
  ...
  },
  {
    ...
    text: `Timeline for the Summer 2027 cohort: Applications open November 1, 2026. The application deadline is February 15, 2027 at 11:59 p.m. Central Time, and all materials, including both reference contacts, are due then. All decisions are announced by March 20, 2027; offers go out on a rolling basis and every applicant receives a decision by that date. The program runs in residence for eight weeks from June 1 to July 24, 2027, ending with the research symposium.`,
  },
  {
